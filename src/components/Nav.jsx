...
const Nav = () => {
	...
	return (
		<nav
			className={`fixed w-full bg-black ${
		...
		>
			...
			<div
				className={
					nav ? "md:hidden fixed top-16 w-full h-screen z-[100]" : "md:hidden"
				}
			>
				<div
					className={
					...
					{nav && (
						<>
							<div className="border-b border-primaryText mb-16">
								<p className="w-[100%] md:w-[90%] py-4 break-words text-secondaryText tracking-widest uppercase font-light">
									Power<span className="text-accent">力</span>
								</p>
							</div>
