        ...
        <div className="max-w-[1440px] mx-auto px-10 py-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7">
               {gymClasses.map((gymClass) => (
                    <div key={gymClass.name} className="bg-white w-full max-w-[400px] shadow-xl mx-auto">
                        <Image 
                            src={gymClass.image}
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="text-[#29282D] text-2xl uppercase tracking-wider hover:text-accent cursor-pointer py-3">{gymClass.name}</h3>
