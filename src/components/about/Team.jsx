  ...
  return (
    <section id="team" className="w-full min-h-screen">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0 text-center md:text-left pt-40 pb-20 px-10">
            <h2 className="text-4xl md:text-5xl uppercase tracking-wide text-[#29282D] w-full md:w-[310px]">Meet our strongest team</h2>
            <Link 
                href={"/about#team"}
            ...
            {team.map((trainer) => (
                <li key={trainer.name} className="relative group">
                    ...
                    <div className="hidden group-hover:block group-hover:absolute top-[50%] left-[50%] translate-x-[-50%] text-center">
                        <h3 className="text-white text-2xl uppercase tracking-wide hover:text-accent duration-300 cursor-pointer">{trainer.name}</h3>
                        <p className="py-2 uppercase text-white text-sm tracking-widest">{trainer.expertise}</p>
                        <div className="mt-2 flex justify-center items-center gap-4 text-white">
                            <FaFacebookF size={25} className="hover:text-accent duration-300 cursor-pointer" />
                            <FaTwitter size={25} className="hover:text-accent duration-300 cursor-pointer" />
