  ...
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mt-16">
        {pricingPlans.map((plan) => (
            <div key={plan.membership} className="relative bg-[#29282d] text-center text-white uppercase max-w-[500px]">
                <div className="p-10">
                    <h3 className="tracking-wide text-4xl">{plan.membership}</h3>
                    <h4 className="text-4xl pt-4"><span className="text-3xl mr-1">£</span>{plan.price} <span className="text-2xl text-accent">p/m</span></h4>
                </div>
